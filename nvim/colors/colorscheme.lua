...
local all = require('seblj.utils').highlight_all
...
all({
    ...
    { 'LspDiagnosticsDefaultError', { guifg = c.error, guibg = 'NONE', gui = 'undercurl' } },
    { 'LspDiagnosticsDefaultWarning', { guifg = c.orange, guibg = 'NONE', gui = 'undercurl' } },
    { 'LspDiagnosticsDefaultInformation', { guifg = c.yellow, guibg = 'NONE', gui = 'undercurl' } },
    { 'LspDiagnosticsDefaultHint', { guifg = c.yellow, guibg = 'NONE', gui = 'undercurl' } },
