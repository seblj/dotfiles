...
" Default GUI Colours
let s:rederror = "ff0000"
let s:menubackground = "313131"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    if version >= 700
        ...
        call <SID>X("PMenu", s:foreground, s:menubackground, "NONE")
	...
	" vim-gitgutter
	call <SID>X("GitGutterAdd", s:darkgreen, "", "")
	call <SID>X("GitGutterChange", s:orange, "", "")
	call <SID>X("GitGutterDelete", s:red, "", "")
	" call <SID>X('GitGutterChangeDelete' , 140 , '' , 'none' , 'none')
	
	" Airline
	call <SID>X("airline_section_error", s:wine, "", "")
	call <SID>X("airline_section_warning", s:wine, "", "")
